...
local defaults = {
	...
	["ConROC_Melee_Seal_Righteousness"] = false,
	["ConROC_Melee_Seal_Blood"] = true, -- TBC Horde default
	["ConROC_Melee_Seal_Vengeance"] = true, -- TBC Alliance default
	["ConROC_Melee_Judgement_Crusader"] = true,
	["ConROC_Melee_Judgement_Blood"] = false,
	["ConROC_Melee_Judgement_Command"] = false,
	["ConROC_Melee_Judgement_Vengeance"] = false,
	["ConROC_Melee_Bless_None"] = false,
	...
	["ConROC_Healer_Seal_Blood"] = false,
	["ConROC_Healer_Seal_Vengeance"] = false,
	["ConROC_Healer_Judgement_Crusader"] = true,
	["ConROC_Healer_Judgement_Blood"] = false,
	["ConROC_Healer_Judgement_Command"] = false,
	["ConROC_Healer_Judgement_Vengeance"] = false,
	["ConROC_Healer_Bless_None"] = false,
	...
	["ConROC_Tank_Seal_Blood"] = false,
	["ConROC_Tank_Seal_Vengeance"] = false,
	["ConROC_Tank_Judgement_Crusader"] = true,
	["ConROC_Tank_Judgement_Blood"] = false,
	["ConROC_Tank_Judgement_Command"] = false,
	["ConROC_Tank_Judgement_Vengeance"] = false,
	["ConROC_Tank_Bless_None"] = false,
	...
	["ConROC_PvP_Seal_Righteousness"] = false,
	["ConROC_PvP_Seal_Blood"] = true,
	["ConROC_PvP_Seal_Vengeance"] = true,
	["ConROC_PvP_Judgement_Crusader"] = true,
	["ConROC_PvP_Judgement_Blood"] = false,
	["ConROC_PvP_Judgement_Command"] = false,
	["ConROC_PvP_Judgement_Vengeance"] = false,
	["ConROC_PvP_Bless_None"] = false,
...
function ConROC:RotationChoices()
	...
	ConROC_RotationSettingsTable = {
	    ...
	    spells = {
      	...
      	{spellID = ids.Debuff.JudgementofCommand, spellCheckbox = "Judgement_Command", reqLevel = 20, type = "judgement", seal = ids.Ability.SealofCommand},
			{spellID = ids.Debuff.JudgementofBlood, spellCheckbox = "Judgement_Blood", reqLevel = 64, type = "judgement", seal = ids.Ability.SealofBlood}, -- TBC Horde
			{spellID = ids.Debuff.JudgementofVengeance, spellCheckbox = "Judgement_Vengeance", reqLevel = 64, type = "judgement", seal = ids.Ability.SealofVengeance}, -- TBC Alliance
	    ...
	    spells = {
			...
			{spellID = ids.Ability.SealofBlood, spellCheckbox = "Seal_Blood", reqLevel = 64, type="spell"}, -- TBC Horde
			{spellID = ids.Ability.SealofVengeance, spellCheckbox = "Seal_Vengeance", reqLevel = 64, type="spell"}, -- TBC Alliance
	    },
	    groupType = "radioButtons"
	  },
	  {
	    frameName = "Blessings",
	    spells = {
	    	{spellID = "None", spellCheckbox = "Bless_None", reqLevel = 1, type="custom"},
	...
	for i = 1, #_table do
		    ...
		    for j = 1, #_spells do
				...
				if _spellData.type == "spell" then
					...
					if type(_spellData.spellID) == "number" then
					-- Check if player knows ANY rank of the spell (not just specific ID)
					local hasSpell = false
					if spellName then
						-- Check if the spell name exists in spellbook
						for k = 1, 500 do
							local bookSpellName = GetSpellBookItemName(k, BOOKTYPE_SPELL)
					...
					if _Player_Level >= _spellData.reqLevel and hasSpell then
							lFrame = oItem;
							lFrame:Show();
				...
				elseif _spellData.type == "judgement" then
					...
					-- Check if player knows ANY rank of the seal (not just specific ID)
					local sealName = GetSpellInfo(_spellData.seal)
					local hasSeal = false
					if sealName then
						-- Check if the seal name exists in spellbook
						for i = 1, 500 do
					...
					if _Player_Level >= _spellData.reqLevel and hasSeal then
						lFrame = oItem;
						scrollHeight = scrollHeight + math.ceil(lFrame:GetHeight());
						spellFrameHeight = spellFrameHeight + math.ceil(oItem:GetHeight());
						lFrame:Show();
