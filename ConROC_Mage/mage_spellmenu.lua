...
local defaults = {
	...
	["ConROC_Caster_Armor_Mage"] = false,
	["ConROC_Caster_Filler_Fireball"] = true,
	["ConROC_Caster_Filler_Frostbolt"] = false,
	["ConROC_Caster_Filler_ArcaneMissiles"] = false,
	["ConROC_Caster_CD_Evocation"] = true,
	["ConROC_Caster_CD_ArcanePower"] = true,
	["ConROC_Caster_CD_Combustion"] = true,
	["ConROC_Caster_CD_IcyVeins"] = true,
	["ConROC_Caster_AoE_DragonBreath"] = false,
	...
	["ConROC_PvP_Armor_Ice"] = true,
	["ConROC_PvP_Armor_Mage"] = false,
	["ConROC_PvP_Filler_Fireball"] = true,
	["ConROC_PvP_Filler_Frostbolt"] = false,
	["ConROC_PvP_Filler_ArcaneMissiles"] = false,
	["ConROC_PvP_CD_Evocation"] = true,
	["ConROC_PvP_CD_ArcanePower"] = true,
	["ConROC_PvP_CD_Combustion"] = true,
	["ConROC_PvP_CD_IcyVeins"] = true,
	["ConROC_PvP_AoE_DragonBreath"] = false,
	["ConROC_PvP_AoE_ArcaneExplosion"] = false,
	["ConROC_PvP_AoE_Flamestrike"] = false,
	["ConROC_PvP_AoE_Blizzard"] = false,
...
function ConROC:RotationChoices()
	...
	ConROC_RotationSettingsTable = {
	    ...
	    frameName = "AoEs",
	    spells = {
	    	{spellID = ids.Ability.DragonBreath, spellCheckbox = "AoE_DragonBreath", reqLevel = 40, type="spell"},
...
local function ConROC_NoOptionsFrame()
    ...
    ConROCNoOptions:SetSize(ConROCScrollFrame:GetWidth(), 80)
    ...
    ConROCNoOptions.text:SetWidth(ConROCNoOptions:GetWidth())
    ...
    ConROCNoOptions.text:SetTextColor(1, 1, 1)
