...
local defaults = {
	...
	["ConROC_Caster_Debuff_DevouringPlague"] = false,
	...
	["ConROC_Caster_Spell_PrayerofMending"] = false,
	["ConROC_Caster_Spell_BindingHeal"] = false,
	...
	["ConROC_Healer_Debuff_DevouringPlague"] = false,
	...
	["ConROC_Healer_Spell_PrayerofMending"] = true,
	["ConROC_Healer_Spell_BindingHeal"] = true,
	...
	["ConROC_PvP_Debuff_VampiricTouch"] = true,
	["ConROC_PvP_Debuff_ShadowWordPain"] = true,
	["ConROC_PvP_Debuff_DevouringPlague"] = false,
	...
	["ConROC_PvP_Spell_ShadowWordDeath"] = true,
	["ConROC_PvP_Spell_PrayerofMending"] = false,
	["ConROC_PvP_Spell_BindingHeal"] = false,
	...
	ConROC_RotationSettingsTable = {
		{
		  frameName = "Debuffs",
		  spells = {
			  {spellID = ids.Ability.VampiricTouch, spellCheckbox = "Debuff_VampiricTouch", reqLevel = 20, type = "spell"},
			  {spellID = ids.Ability.ShadowWordPain, spellCheckbox = "Debuff_ShadowWordPain", reqLevel = 4, type = "spell"},
			  {spellID = ids.Ability.DevouringPlague, spellCheckbox = "Debuff_DevouringPlague", reqLevel = 20, type = "spell"},
		...
		},
		{
		  frameName = "Spells",
		  spells = {
			  {spellID = ids.Ability.Shadowfiend, spellCheckbox = "Spell_Shadowfiend", reqLevel = 66, type="spell"},
			  {spellID = ids.Ability.ShadowWordDeath, spellCheckbox = "Spell_ShadowWordDeath", reqLevel = 62, type="spell"},
			  {spellID = ids.Ability.PrayerofMending, spellCheckbox = "Spell_PrayerofMending", reqLevel = 68, type="spell"},
			  {spellID = ids.Ability.BindingHeal, spellCheckbox = "Spell_BindingHeal", reqLevel = 64, type="spell"},
		  },
		  groupType = "checkBoxes"
		},
		{
