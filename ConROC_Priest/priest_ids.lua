...
--Shadow
	...
	MindVision = 2096,
	PsychicScream = 8122,
	Shadowfiend = 34433, --TBC talent ability
	ShadowProtection = 976,
	ShadowWordDeath = 32379, --TBC ability (Rank 1)
	ShadowWordPain = 589,
	Shadowform = 15473,
...
ids.Discipline_Talent = {
	...
	InnerFocus = 8,
	Meditation = 9,
	ImprovedInnerFire = 10,
	MentalAgility = 11,
	ImprovedManaBurn = 12,
	MentalStrength = 13,
	DivineSpirit = 14,
	ImprovedDivineSpirit = 15,
	FocusedPower = 16,
	ForceofWill = 17,
	FocusedWill = 18,
	PowerInfusion = 19,
...
--Ranks
	...
	if IsSpellKnown(ids.Rank.InnerFireRank7) then ids.Ability.InnerFire = ids.Rank.InnerFireRank7;
	elseif IsSpellKnown(ids.Rank.InnerFireRank6) then ids.Ability.InnerFire = ids.Rank.InnerFireRank6;
	...
	if IsSpellKnown(ids.Rank.ManaBurnRank6) then ids.Ability.ManaBurn = ids.Rank.ManaBurnRank6;
	elseif IsSpellKnown(ids.Rank.ManaBurnRank5) then ids.Ability.ManaBurn = ids.Rank.ManaBurnRank5;
	...
	if IsSpellKnown(ids.Rank.PowerWordFortitudeRank7) then ids.Ability.PowerWordFortitude = ids.Rank.PowerWordFortitudeRank7;
	elseif IsSpellKnown(ids.Rank.PowerWordFortitudeRank6) then ids.Ability.PowerWordFortitude = ids.Rank.PowerWordFortitudeRank6;
	...
	if IsSpellKnown(ids.Rank.PowerWordShieldRank12) then ids.Ability.PowerWordShield = ids.Rank.PowerWordShieldRank12;
	elseif IsSpellKnown(ids.Rank.PowerWordShieldRank11) then ids.Ability.PowerWordShield = ids.Rank.PowerWordShieldRank11;
	elseif IsSpellKnown(ids.Rank.PowerWordShieldRank10) then ids.Ability.PowerWordShield = ids.Rank.PowerWordShieldRank10;
...
--Holy
	...
	elseif IsSpellKnown(ids.Rank.PrayerofHealingRank5) then ids.Ability.PrayerofHealing = ids.Rank.PrayerofHealingRank5;
	...
	if IsSpellKnown(ids.Rank.ResurrectionRank6) then ids.Ability.Resurrection = ids.Rank.ResurrectionRank6;
	elseif IsSpellKnown(ids.Rank.ResurrectionRank5) then ids.Ability.Resurrection = ids.Rank.ResurrectionRank5;
...
--Shadow
	...
	if IsSpellKnown(ids.Rank.MindFlayRank7) then ids.Ability.MindFlay = ids.Rank.MindFlayRank7;
	elseif IsSpellKnown(ids.Rank.MindFlayRank6) then ids.Ability.MindFlay = ids.Rank.MindFlayRank6;
	...
	if IsSpellKnown(ids.Rank.ShadowProtectionRank4) then ids.Ability.ShadowProtection = ids.Rank.ShadowProtectionRank4;
	elseif IsSpellKnown(ids.Rank.ShadowProtectionRank3) then ids.Ability.ShadowProtection = ids.Rank.ShadowProtectionRank3;
	...
	if IsSpellKnown(ids.Rank.VampiricTouchRank3) then ids.Ability.VampiricTouch = ids.Rank.VampiricTouchRank3;
	elseif IsSpellKnown(ids.Rank.VampiricTouchRank2) then ids.Ability.VampiricTouch = ids.Rank.VampiricTouchRank2; end
	...
	elseif _ShadowWeavingRank == 4 then ids.Buff.ShadowWeaving = ids.Rank.ShadowWeavingRank4;
	elseif _ShadowWeavingRank == 3 then ids.Buff.ShadowWeaving = ids.Rank.ShadowWeavingRank3;
	elseif _ShadowWeavingRank == 2 then ids.Buff.ShadowWeaving = ids.Rank.ShadowWeavingRank2; end
end
